...
public class NuevaInstruccionDialog extends JDialog {
	...
	public static void main(String[] args) {
		try {
			NuevaInstruccionDialog dialog = new NuevaInstruccionDialog();
	 ...
	 * Create the dialog.
	 */
	public NuevaInstruccionDialog() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(NuevaInstruccionDialog.class.getResource("/dad/recetapp/ui/images/logo.png")));
		setTitle("Nueva instrucci\u00F3n para 'Alb\u00F3ndigas'");
