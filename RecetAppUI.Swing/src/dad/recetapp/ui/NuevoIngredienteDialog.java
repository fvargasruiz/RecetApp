...
public class NuevoIngredienteDialog extends JDialog {
	...
	public static void main(String[] args) {
		try {
			NuevoIngredienteDialog dialog = new NuevoIngredienteDialog();
	 ...
	 * Create the dialog.
	 */
	public NuevoIngredienteDialog() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(NuevoIngredienteDialog.class.getResource("/dad/recetapp/ui/images/logo.png")));
		setTitle("Nuevo ingrediente para 'Alb\u00F3ndigas'");
